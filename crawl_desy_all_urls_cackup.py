...
async def crawl_site():
    ...
    excluded_selectors = [
        ...
        '[style*="opacity: 0"]',      # Invisible due to opacity (common for animations)
        '[style*="clip:rect(0"]',     # Clipped content (off-screen text)
        '[style*="clip-path"]',       # CSS clip-path hiding
        '[style*="height: 0"]',       # Zero height (content hidden vertically)
        '[style*="width: 0"]',        # Zero width (content hidden horizontally)
        '[aria-expanded="false"]',    # Collapsed element (ARIA state for inactive)
        
        # ========================================================================
        # SECTION 2: Disabled/Inactive links and menu items
        # ========================================================================
        ...
        'a.disabled', 'a.inactive',   # Direct disabled/inactive class on links
        ...
        '[data-disabled="true"]',     # Data attribute disabled state
        '[data-inactive="true"]',     # Data attribute inactive state
        '[data-active="false"]',      # Explicitly marked as inactive
        ...
        # ========================================================================
        # SECTION 3: Navigation and menus (common patterns across websites)
        # ========================================================================
        ...
        # ========================================================================
        # SECTION 7: Loading and placeholder elements
        # ========================================================================
        '[class*="loading"]', '[id*="loading"]',
        '[class*="placeholder"]',
        
        # ========================================================================
        # SECTION 8: Skip links and accessibility (often off-screen)
        # ========================================================================
        ...
        'a[href^="urn:"]',                        # URN
        # Relative / malformed links (avoid "Invalid URL" / Missing scheme or netloc)
